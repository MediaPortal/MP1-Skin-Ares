  ...
  public class ImagePlugin : IPlugin, ISetupForm
  {
    private System.Threading.Timer fancyTimer = new System.Threading.Timer((TimerCallback) (state =>
    {
      ...
      catch
      {
        ...
        StreamWriter streamWriter = new StreamWriter(folderPath + "\\Team MediaPortal\\MediaPortal\\log\\AresPlugin.log", true);
    ...
    void IPlugin.Start()
    {
      ...
      try
      {
        ...
        StreamWriter streamWriter = new StreamWriter(folderPath1 + "\\Team MediaPortal\\MediaPortal\\log\\AresPlugin.log", true);
      ...
      try
      {
        ...
        StreamWriter streamWriter = new StreamWriter(folderPath2 + "\\Team MediaPortal\\MediaPortal\\log\\AresPlugin.log", true);
        streamWriter.WriteLine(utcNow.ToString() + str3);
        streamWriter.Close();
      }
      catch
