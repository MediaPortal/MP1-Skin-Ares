...
!define Ares_nameoutput "Ares_${SkinReleaseVersion}"
!define Ext_filename "Ares.xmp2"   
...
!system 'move "${git_InstallScripts}\Release\${Ares_nameoutput}.mpe1" "${git_OUT}\${Ares_nameoutput}.mpe1"'

!undef Ext_filename 
!undef properskinpath
#!undef Ares_nameoutput
